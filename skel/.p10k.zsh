# Generated by Powerlevel10k configuration wizard on 2020-01-10 at 14:28 AEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 20339.
# Wizard options: powerline, rainbow, time, angled separators, sharp heads, flat tails,
# 2 lines, solid, full frame, darkest, sparse, concise, transient_prompt,
# instant_prompt=off.
