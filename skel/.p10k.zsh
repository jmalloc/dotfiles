# Generated by Powerlevel10k configuration wizard on 2019-12-27 at 12:08 AEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 20339.
# Wizard options: compatible, rainbow, time, flat tails, 2 lines, solid, full frame,
# darkest, sparse, concise, transient_prompt, instant_prompt=off.
